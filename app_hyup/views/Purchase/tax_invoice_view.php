...
<div class="p-4 bg-white font-sans text-xs text-gray-800">
    <div class="flex items-center !border-b !font-sans !border-gray-300 !pb-3 justify-between">
        ...
        <div class="flex items-center gap-2 !text-xs">
            ...
            <form id="searchForm" action="/purchase/tax_invoice" method="GET" class="flex items-center border border-gray-300 gap-2 rounded-sm overflow-hidden w-[330px] !text-xs">
        ...
        <div class="ml-auto flex w-full items-center gap-2 justify-between">
            <div class="flex items-center gap-2">
                ...
                <div class="flex items-center gap-1 !text-xs">
                    ...
                    <button type="button" onclick="window.location.href = '/purchase/tax_invoice'" class="sm-btn">
                        초기화
                    </button>
                </div>
            </div>
