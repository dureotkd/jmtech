        ...
        <div class="flex items-center gap-2 !text-xs">
            ...
            <div class="relative">
                <div
                    ...
                    data-dropdown-id="tax-bill-dropdown"
                    style="display: inline-block;">
                    <button
                        type="button"
                        class="!px-2 py-1 !border-1 !border-gray-300 hover:bg-gray-100"
                        onclick="toggleCustomDropdown(event, 'tax-bill-dropdown')">
                ...
                <div
                    data-dropdown-menu="tax-bill-dropdown"
        ...
        <div class="ml-auto flex w-full items-center gap-2 justify-between">
            ...
            <div class="flex items-center gap-2">
                <button
                    ...
                    class="flex h-[24px] items-center gap-1 bg-[#2ea3eb] text-white px-4">
