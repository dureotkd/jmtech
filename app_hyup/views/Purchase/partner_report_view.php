...
<div class="p-4 bg-white font-sans text-xs text-gray-800">
    <div class="flex items-center !border-b !font-sans !border-gray-300 !pb-3 justify-between">
        ...
        <div class="flex items-center gap-2 !text-xs">
            ...
            <form id="searchForm" action="/purchase/partner_report" method="GET" class="flex items-center border border-gray-300 gap-2 rounded-sm overflow-hidden w-[330px] !text-xs">
            ...
            <div class="relative">
                <div
                    ...
                    data-dropdown-id="purchase-order-dropdown"
                    style="display: inline-block;">
                    <button
                        type="button"
                        class="!px-2 py-1 !border-1 !border-gray-300 hover:bg-gray-100"
                        onclick="toggleCustomDropdown(event, 'purchase-order-dropdown')">
                ...
                <div
                    data-dropdown-menu="purchase-order-dropdown"
    ...
    <div class="flex items-center gap-2 mb-4 !text-xs">
        ...
        <div class="ml-auto flex w-full items-center gap-2 justify-between">
            <div class="flex items-center gap-2">
                <button onclick="delete_estimate(event);" type="button" class="!my-2  flex items-center gap-1 border border-gray-300 rounded h-7 !px-3 bg-white hover:bg-gray-50 transition text-xs"><input multiple="" type="file" style="display: none;">
                    삭제
                </button>
                ...
                <div class="flex items-center gap-1 !text-xs">
                    ...
                    <button type="button" onclick="window.location.href = '/purchase/partner_report'" class="sm-btn">
                        초기화
                    </button>
                </div>
            </div>
            <button
                onclick="open_popup_default('<?= REACT_PATH ?>?sub_type=B','<?= $title ?>',1000,820);"
                type="button"
...
<script>
    ...
    function go_detail(estimate_id) {
        open_popup_default(`/sales/estimate_detail?id=${estimate_id}`, '발주서 상세', 1000, 820);
    }
