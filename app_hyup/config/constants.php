...
define('도메인', ($_SERVER['REMOTE_ADDR'] === '127.0.0.1') ? 'https://jmtech.test' : 'https://www.jmtech.asia');

define('DEFAULT_PROFILE_IMAGE', 'https://www.jmtech.asia/assets/app_hyup/images/default_profile.png');

define('NICE_PROGRAM_PATH', "/var/www/html/gamemarket-service-new1/assets/app_hyup/lib/CPClient_linux_x64");
define('NAVER_CALLBACK_URL', ($_SERVER['REMOTE_ADDR'] === '127.0.0.1') ? 'http://jmtech.test/api/auth/callback/naver' : 'https://www.jmtech.asia/api/auth/callback/naver');
