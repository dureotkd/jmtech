    ...
    <div class="w-full !px-2 !text-xs font-sans font-300">
        ...
        <div class="flex items-center justify-between w-full print-hide">
            ...
            <div class="flex space-x-2">
                <button onclick="window.location.href = '<?= REACT_PATH ?>?id=<?= $estimate['id'] ?>'" class="flex items-center border border-gray-400 px-3 py-1 gap-1  text-xs hover:bg-gray-100">
...
<script>
    ...
    const handle_copy = (e) => {
        window.location.href = `<?= REACT_PATH ?>?tab=copy&id=<?= $estimate['id'] ?>`;
    }
