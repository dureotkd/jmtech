...
<div class="flex flex-col !gap-12 relative w-full bg-cover bg-center">
    ...
    <div class="lg:!px-0 !px-4 !mt-6 flex flex-col lg:gap-6 gap-2 !mx-auto">

        <div class="!border-b !border-[#e6e0d7] !pb-4 !mb-4">
            <h1 class="color-sm  !text-lg">공지 <span class="text-black"><?= $notice['title'] ?></span></h1>
            <p class="!text-sm text-[#a09a92] !mt-1">Notice &nbsp;&nbsp;<?= explode(' ', $notice['created_at'])[0] ?></p>
        </div>
