        ...
        <div class="flex items-center gap-2 !text-xs">
            ...
            <div class="relative">
                <div
                    ...
                    data-dropdown-id="report-dropdown"
                    style="display: inline-block;">
                    <button
                        type="button"
                        class="!px-2 py-1 !border-1 !border-gray-300 hover:bg-gray-100"
                        onclick="toggleCustomDropdown(event, 'report-dropdown')">
                ...
                <div
                    data-dropdown-menu="report-dropdown"
                    ...
                    <div class="w-full flex flex-col justify-start !text-xs">
                        ...
                        <button class="flex items-center !border-b-1 !border-gray-300 gap-2 !text-left !p-4 sm-hover w-full" onclick="download_pdfs1();" type="button">
                        ...
                        <button class="flex items-center gap-2 !text-left !p-4 sm-hover w-full" onclick="download_pdfs2();" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text-icon lucide-file-text">
                                <path d="M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z" />
                                <path d="M14 2v5a1 1 0 0 0 1 1h5" />
                                <path d="M10 9H8" />
